...
if (getRversion() >= "2.15.1")  
    globalVariables(c('top', 'statisticFrame', 'statisticVariable', 'buttonsFrame',
                      ...
                      'pointsVariable', 'linesVariable', 'eqmccVariable', 'diffmatVariable', 'uselettersVariable',
                      'chartVariable', 'showcasesVariable', 'detailsVariable', 'quietVariable', 'eqmccCB',
                      'quietCB', 'chartCB', 'showcasesCB', 'detailsCB', 'diffmatCB', 'detailsCB', 'showcasesVariable',
                      'completeVariable'))
